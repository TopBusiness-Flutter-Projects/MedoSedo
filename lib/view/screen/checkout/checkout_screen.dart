...
import 'package:medosedo_ecommerce/data/model/body/order_place_model.dart';
...
import 'package:medosedo_ecommerce/view/basewidget/amount_widget.dart';
...
import 'package:medosedo_ecommerce/view/basewidget/my_dialog.dart';
import 'package:medosedo_ecommerce/view/basewidget/show_custom_snakbar.dart';
import 'package:medosedo_ecommerce/view/basewidget/textfield/custom_textfield.dart';
import 'package:medosedo_ecommerce/view/screen/address/saved_address_list_screen.dart';
import 'package:medosedo_ecommerce/view/screen/address/saved_billing_Address_list_screen.dart';
import 'package:medosedo_ecommerce/view/screen/checkout/widget/custom_check_box.dart';
import 'package:medosedo_ecommerce/view/screen/checkout/widget/offline_payment.dart';
import 'package:medosedo_ecommerce/view/screen/checkout/widget/wallet_payment.dart';
          ...
          return InkWell(
            onTap: () async {
              if(order.addressIndex == null && !widget.onlyDigital) {
                ...
                if(_paymentMethods[order.paymentMethodIndex].name == 'cash_on_delivery' && !widget.onlyDigital) {
                ...
                else  if(_paymentMethods[order.paymentMethodIndex].name == 'offline_payment'){
                ...
                }else if(_paymentMethods[order.paymentMethodIndex].name == 'wallet'){
          ...
          Expanded(
            child: ListView(physics: BouncingScrollPhysics(), padding: EdgeInsets.all(0), children: [
              ...
              Container(
                ...
                child: Consumer<OrderProvider>(
                  builder: (context, order, child) {
                     _couponDiscount = Provider.of<CouponProvider>(context).discount != null ?
