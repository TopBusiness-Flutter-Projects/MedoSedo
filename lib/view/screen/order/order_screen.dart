...
import 'package:medosedo_ecommerce/view/basewidget/not_loggedin_widget.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/order_shimmer.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/order_type_button.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/order_widget.dart';
                      ...
                      builder: (context, order, child) {
                        ...
                        return Expanded(
                          child: orderList.isEmpty
                              ? Center(
                                  child: Text(
                                      getTranslated('no_order', context) ??
                                          'ليس لديك اي طلبات'),
                                )
                              : RefreshIndicator(
                                  backgroundColor:
