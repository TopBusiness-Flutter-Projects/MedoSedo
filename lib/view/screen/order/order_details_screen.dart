...
import 'package:medosedo_ecommerce/view/basewidget/shimmer_loading.dart';
import 'package:medosedo_ecommerce/view/screen/dashboard/dashboard_screen.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/cal_chat_widget.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/cancel_and_support_center.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/ordered_product_list.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/payment_info.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/seller_section.dart';
import 'package:medosedo_ecommerce/view/screen/order/widget/shipping_info.dart';
                        ...
                        child: Row(
                          children: [RichText(text: TextSpan(
                            children: <TextSpan>[
                              ...
                              TextSpan( text:order.trackingModel.id!=0?order.trackingModel.id.toString():"",
                                  style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE,
                            ...
                            Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Expanded(child: Padding(
                                    ...
                                    child: Text(' ${order.orderModel.id!=0&&order.orderModel.shippingAddressData!.id != 0 ?
