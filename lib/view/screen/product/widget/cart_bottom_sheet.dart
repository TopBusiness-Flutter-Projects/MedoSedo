...
import 'package:medosedo_ecommerce/data/model/response/product_details_model.dart'
    as pd;
          ...
          Container(
            ...
            child: Consumer<ProductDetailsProvider>(
              builder: (ctx, details, child) {
                ...
                print(
                    'bangla===>$selectedIndex/${widget.product.images!.length}');
