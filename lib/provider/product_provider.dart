...
class ProductProvider extends ChangeNotifier {
  ...
  Product _recommendedProduct = Product();
  ...
  Future<void> getLatestProductList(int offset, BuildContext context,
    ...
    if (!_offsetList.contains(offset)) {
      ...
      if (apiResponse.response != null &&
        ...
        if (ProductModel.fromJson(apiResponse.response!.data)
            .products
            .isNotEmpty) {
          ...
          if (_latestProductList.isEmpty) {
            print('offset =====> Empty List');
            _latestProductList.addAll(
                ProductModel.fromJson(apiResponse.response!.data).products);
          } else {
            print('offset =====> here i have List');
            _latestProductList = [
              ..._latestProductList,
              ...ProductModel.fromJson(apiResponse.response!.data).products
            ];
