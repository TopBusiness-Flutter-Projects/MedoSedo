...
import 'package:medosedo_ecommerce/data/repository/banner_repo.dart';
import 'package:medosedo_ecommerce/data/repository/brand_repo.dart';
import 'package:medosedo_ecommerce/data/repository/cart_repo.dart';
import 'package:medosedo_ecommerce/data/repository/category_repo.dart';
import 'package:medosedo_ecommerce/data/repository/chat_repo.dart';
import 'package:medosedo_ecommerce/data/repository/coupon_repo.dart';
import 'package:medosedo_ecommerce/data/repository/featured_deal_repo.dart';
import 'package:medosedo_ecommerce/data/repository/flash_deal_repo.dart';
import 'package:medosedo_ecommerce/data/repository/location_repo.dart';
import 'package:medosedo_ecommerce/data/repository/notification_repo.dart';
import 'package:medosedo_ecommerce/data/repository/onboarding_repo.dart';
import 'package:medosedo_ecommerce/data/repository/product_details_repo.dart';
import 'package:medosedo_ecommerce/data/repository/order_repo.dart';
import 'package:medosedo_ecommerce/data/repository/product_repo.dart';
import 'package:medosedo_ecommerce/data/repository/profile_repo.dart';
import 'package:medosedo_ecommerce/data/repository/search_repo.dart';
import 'package:medosedo_ecommerce/data/repository/seller_repo.dart';
import 'package:medosedo_ecommerce/data/repository/splash_repo.dart';
import 'package:medosedo_ecommerce/data/repository/support_ticket_repo.dart';
import 'package:medosedo_ecommerce/data/repository/top_seller_repo.dart';
import 'package:medosedo_ecommerce/data/repository/wallet_transaction_repo.dart';
import 'package:medosedo_ecommerce/data/repository/wishlist_repo.dart';
import 'package:medosedo_ecommerce/helper/network_info.dart';
import 'package:medosedo_ecommerce/provider/auth_provider.dart';
import 'package:medosedo_ecommerce/provider/banner_provider.dart';
...
import 'package:medosedo_ecommerce/provider/coupon_provider.dart';
...
import 'package:medosedo_ecommerce/provider/flash_deal_provider.dart';
...
import 'package:medosedo_ecommerce/provider/location_provider.dart';
import 'package:medosedo_ecommerce/provider/notification_provider.dart';
import 'package:medosedo_ecommerce/provider/onboarding_provider.dart';
import 'package:medosedo_ecommerce/provider/product_details_provider.dart';
...
import 'package:medosedo_ecommerce/provider/search_provider.dart';
import 'package:medosedo_ecommerce/provider/seller_provider.dart';
import 'package:medosedo_ecommerce/provider/splash_provider.dart';
import 'package:medosedo_ecommerce/provider/support_ticket_provider.dart';
...
import 'package:medosedo_ecommerce/provider/wallet_transaction_provider.dart';
import 'package:medosedo_ecommerce/provider/wishlist_provider.dart';
