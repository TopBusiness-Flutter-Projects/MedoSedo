...
class Colors {
  ...
  Colors(
      {required int id, required String name, required String code, required String createdAt, required String updatedAt}) {
    this._id = id;
    this._name = name;
    this._code = code;
    this._createdAt = createdAt;
...
class Announcement {
  ...
  Announcement({required String status, required String color,required String textColor, required String announcement}) {
    if (status != null) {
      this._status = status;
    }
    if (color != null) {
